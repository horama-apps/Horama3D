...
export const WIFI_SIGN_ACCENT_COLOR = '#d97891';
export const QR_SIGN_ACCENT_COLOR = '#4f8c7d';
export const BUSINESS_SIGNAGE_ACCENT_COLOR = '#c8755b';
export const DISPLAY_ACCESSORIES_ACCENT_COLOR = '#9b7800';
export const BUSINESS_PACKAGES_ACCENT_COLOR = '#d5b72f';
