    ...
    params: [
      ...
      },
      {
        ...
        options: [
          { label: 'STL', value: 'stl' },
          { label: '3MF', value: '3mf' },
          { label: 'STL zip', value: 'stl_zip' },
          { label: 'STL combined', value: 'stl_combined' },
        ],
      },
      {
        kind: 'select',
        key: 'plate_size_mm',
        label: 'Plate size',
        defaultValue: '250x250x250',
        options: [
          { label: '250 x 250 x 250 mm', value: '250x250x250' },
          { label: '220 x 220 x 250 mm', value: '220x220x250' },
          { label: '300 x 300 x 300 mm', value: '300x300x300' },
        ],
      },
      {
        kind: 'number',
